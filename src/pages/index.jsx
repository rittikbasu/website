    ...
    <>
      ...
      <Container className="-mt-[64px] flex h-screen items-center justify-center md:-mt-10">
        <div className="max-w-2xl">
          ...
          <h1
            className="md:dark:text-edge-outline-dark md:text-edge-outline-light text-edge-outline-light-sm text-edge-outline-dark-sm z-10 animate-title bg-zinc-900 bg-clip-text  font-heading 
