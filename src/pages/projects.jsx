...
//     name: 'Animaginary',
//     description:
//       'High performance web animation library, hand-written in optimized WASM. mance web animation library, hand-written in optimized WASM.',
          ...
          {data.map((project) => (
            <Card as="li" key={project.title}>
              ...
              <p className="relative z-10 mt-6 flex text-sm font-medium text-zinc-400 transition group-hover:text-indigo-500 dark:text-zinc-200">
                ...
                <LinkIcon className="ml-6 h-6 w-6 flex-none" />
                <span className="ml-2">{project.link.label}</span>
              </p>
            </Card>
          ))}
